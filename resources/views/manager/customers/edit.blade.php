            ...
            <div class="col-12">
                ...
                <div class="box">
                    <div class="box-header with-border bg-light">
                        <h4 class="box-title">Edit Customer Form</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="codeID" value="{{$customer->codeID}}" class="form-control"
                                                           data-validation-required-message="This field is required">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="class" value="{{$customer->class}}" class="form-control"
                                                           data-validation-required-message="This field is required">
                                                </div>
                                                @if($errors->has('class'))
                                                    <div class="alert alert-danger">
